...
const { data: categoriesData, pending, refresh, error } = await useFetch(
...
<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      <div>
        <h1 class="text-2xl font-bold text-gray-900 mb-1">Categories</h1>
    ...
    <div v-else-if="error" class="text-center py-12 text-red-600">Failed to load categories</div>
          ...
          <tbody class="divide-y divide-gray-100">
            <tr v-for="category in categories" :key="category.id" class="hover:bg-gray-50">
              <td class="px-4 py-4">
                ...
                <div v-if="category.description" class="text-xs text-gray-400 mt-0.5 truncate max-w-xs">
                  {{ category.description }}
                </div>
              </td>
              <td class="px-4 py-4 text-sm text-gray-500">{{ category.slug }}</td>
              <td class="px-4 py-4 text-sm text-gray-500">{{ category.priority }}</td>
